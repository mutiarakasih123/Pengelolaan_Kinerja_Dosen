    ...
    <div class="col">
      <div class="row">
        ...
        <div class="col-12 content">
            <h6 class="mt-4 mb-2">Edit User</h6>
            <br />
            <form action="/user" method="POST">
            @csrf
              <input type="hidden"  name="id" value="<?php echo($user->id); ?>" />
              <input type="text" name="name" class="form-control mb-2" value="<?php echo($user->name); ?>" placeholder="Nama" />
              <input type="email" name="email" class="form-control mb-2" value="<?php echo($user->email); ?>" placeholder="Email" />
              <input type="date" name="date_birth" class="form-control mb-2" value="<?php echo($user->date_birth); ?>" placeholder="Tanggal lahir" />
              <div class="d-flex align-items-center justify-content-between">
                  <a href="/users" class="btn btn-default" style="width: 100px">Kembali</a>
