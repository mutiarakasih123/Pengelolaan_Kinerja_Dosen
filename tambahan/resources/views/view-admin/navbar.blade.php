...
<div class="container-fluid h-100">
  <div class="row h-100">
<div class="col-5 col-md-3 col-lg-2 collapse show m-0 p-0 h-100 bg-dark" id="collapseExample">
      <h4 class="text-white text-center py-2">Aplikasi Swafoto</h4>
      ...
      <ul class="nav flex-column navbar-dark sticky-top ">
        ...
        <li class="nav-item">
          <a class="nav-link text-white" href="/pesanan-spot">Pesanan</a>
        </li>
        <li class="nav-item">
          <a class="nav-link text-white" href="/spot-foto">Spot Foto</a>
        </li>
        <li class="nav-item">
          <a class="nav-link text-white" href="/users">Users</a>
        </li>
        <li class="nav-item">
          <a class="nav-link text-white" href="/drivers">Drivers</a>
        </li>
        <li class="nav-item">
          <a class="nav-link text-white" href="/admins">Admins</a>
        </li>
        <li class="nav-item">
