...
class TataUsahaController extends Controller
{
    public function viewforminput(Request $request)
    {
         ...
         $sesi_teori = $request->input('sesi_teori');
         $sesi_praktek = $request->input('sesi_praktek');
         ...
         DB::insert("INSERT INTO `tblinput`(`id_input`, `jurusan`, `subunsur`, `kegiatan`, 
                                        ...
                                        `kodemakul`, `namamakul`, `sks_teori`, `sks_praktek`, `sesi_teori`, 
                                        `sesi_praktek`, `nilai_teori`, `nilai_praktek`, `namadosenpengajar_teori`, 
