...
<body>
    <nav class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0">
        <a class="navbar-brand col-sm-3 col-md-2 mr-0" href="https://getbootstrap.com/docs/4.0/examples/dashboard/#">Pengelolaan Kinerja Dosen</a>
        ...
        <div class="row">
            ...
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
                ...
                <p class="lead p-4 text-center">
                    Aplikasi ini untuk............................isi deskripsi aplikasi disini tiara
                </p>
            </main>
        </div>
    </div>
